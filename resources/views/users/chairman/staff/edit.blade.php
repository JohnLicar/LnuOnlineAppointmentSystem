                    ...
                    <form method="POST" action="{{  route('staff.update', $staff) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" value="{{ $staff->first_name }}" autofocus />
                            </div>

                            <div>
                                <x-label for="middle_name" :value="__('Middle Name')" />
                                <x-input id="middle_name" class="block mt-1 w-full" type="text" name="middle_name" value="{{ $staff->middle_name }}" />
                            </div>

                            <div>
                                <x-label for="last_name" :value="__('Last Name')" />
                                <x-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" value="{{ $staff->last_name }}" />
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="contact_number" class="block mt-1 w-full" type="text" name="contact_number" value="{{ $staff->contact_number }}"/>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex">
                                  @if ($staff->avatar)
                                  <img src="{{asset('images/profile/'. $staff->avatar)}}" alt="Teacher Picture"
