                    ...
                    <form method="POST" action="{{  route('counter.store') }}" enctype="multipart/form-data">
                        ...
                        <div >
                            <div>
                                ...
                                <x-input id="description" class="block mt-1 w-full" type="text" name="description" placeholder="Counter Number" :value="old('description')" autofocus/>
                            </div>
