<div class="overflow-x-auto" >
    <div class="w-full">
        ...
        <div class="relative flex space-x-4  mb-6">
            <div>
                <a wire:click.prevent="callQueue({{ $appointments[0]->id }}, {{  $counter_id  }})" onClick="playSound()" class="bg-blue-600 hover:bg-blue-800 transition duration-500 transform hover:scale-105   text-white py-2 px-4 rounded flex">
