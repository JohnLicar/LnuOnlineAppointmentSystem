<div >
    ...
    <div class="relative flex space-x-4  mb-6">
         <a href="{{ route('service.create')}}" class="bg-blue-600 hover:bg-blue-800 transition duration-500 transform hover:scale-105  text-white py-2 px-4 rounded flex">
         ...
         <div class="w-80 bg-white border rounded-lg mt-5 py-2 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 ">
             ...
             <div class="flex items-center ml-5 mb-2 space-x-4">
                 ...
                 <div class="col-span-2">
                     <h1 class="mb-1 text-xl font-semibold text-gray-700">{{ $service->description }}  <span class="font-medium">|</span> {{ $service->code }}</h1>
                     <p class="text-sm font-normal text-gray-600 mr-14">{{  $service->department->description }}</p>
                 </div>
