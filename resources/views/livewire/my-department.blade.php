<div>
    ...
    <div class="relative flex space-x-4 mb-3 ">
        <a href="{{ route('my-department.create')}}" class="bg-blue-600 flex hover:bg-blue-800 transition duration-500 transform hover:scale-105  text-white py-2 px-4 rounded">
    ...
    <div class="flex justify-around pt-5 border-t-2">
        ...
        @forelse ($departments as $my_department)
        <div class="w-80 bg-white border rounded-lg mt-5 py-2 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
            ...
            <div class="flex items-center mb-2 space-x-4">
                <div class="mx-2">
                    <h1 class="mb-1 text-xl font-bold text-gray-700">{{ $my_department->description }}</h1>
                    <p class="text-sm font-normal text-gray-600 mr-14">Assigned CH: <span class="font-semibold  hover:underline">{{ $my_department->chairman->full_name ??  'No assigned Vice Chairman' }}</span></p>
                </div>
            </div>
            ...
            <div class="flex justify-around px-10 mt-2">
                ...
                <div class=" w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                    <a href="{{ route('my-department.show', $my_department) }}">
                ...
                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                    <a href="{{ route('my-department.edit', $my_department) }}">
                        <svg xmlns="http://www.w3.org/2000/svg"  class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="w-4 mr-2 transform hover:text-red-800 hover:scale-110">
                    <form action="{{ route('department.destroy', $my_department) }}" method="POST">
                        @csrf
                        @method('DELETE')
