<div>
    ...
    <div class="relative flex space-x-4 mb-3 ">
        <a href="{{ route('department.create')}}" class="bg-blue-600 hover:bg-blue-800 transition duration-500 transform hover:scale-105  text-white py-2 px-4 rounded">
            ...
            <div class="flex items-center mb-2 space-x-4">
                <div class="mx-2">
                   ...
                   {{-- @foreach ($department->vice_pres as $officer) --}}
                        <p class="text-sm font-normal text-gray-600 mr-14">Assigned VP: <span class="font-semibold  hover:underline">{{ $department->vice_pres[0]->email ??  'No assigned Vice President' }}</span></p>
                        <p class="text-sm font-normal text-gray-600 mr-14">Assigned CH: <span class="font-semibold  hover:underline">{{ $department->vice_pres[1]->email ??  'No assigned Vice Chairman' }}</span></p>
                   {{-- @endforeach --}}
                </div>
            </div>
