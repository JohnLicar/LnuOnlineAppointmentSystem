<div >
    ...
    <div class="relative flex space-x-4  mb-6">
     <a href="{{ route('chairman.create')}}" class="bg-blue-600 hover:bg-blue-800 transition duration-500 transform hover:scale-105  text-white py-2 px-4 rounded">
         ...
         <table class="min-w-max w-full table-auto">
             ...
             <tbody class="text-gray-600 text-base font-light">
                 ...
                 <tr>
                     ...
                     <td class="py-3 px-6 text-center">
                         <div class="flex items-center justify-center">
                             {{ $chairman->department->description }}
                         </div>
                     </td>
