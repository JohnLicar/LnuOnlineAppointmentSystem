<div >
    ...
    <div class=" flex justify-between space-x-4 ">
     <a href="{{ route('chairman.create')}}" class="text-white py-2 px-4 rounded bg-blue-600 flex hover:bg-blue-800 transition duration-500 transform hover:scale-105  ">
        ...
        Add Chairman</a>
     <x-input wire:model.debounce.300ms="search" id="search" class=" right-0 w-1/3" type="search" name="search" placeholder="Search Chairman" :value="old('search')" />
 </div>
 <div class="w-full mt-3">
     <div class="bg-white shadow-md rounded  border-4  border-opacity-100">
        @if (!count($chairmans) == '0')
